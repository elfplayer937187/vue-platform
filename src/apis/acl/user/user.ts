...
// 删除用户接口
export const reqDeleteUser=(id:number)=>request.delete<any,DefaultType>(API.DELETEUSER_URL+`/${id}`)
// 更新用户接口
export const reqUpdateUser=(obj:AddUserType)=>request.put<any,DefaultType>(API.UPDATEUSER_URL,obj)
// 批量删除接口
export const reqBatchRemoveUser=(idList:number[])=>request.delete<any,DefaultType>(API.BATCHREMOVE_URL,{data:idList})  