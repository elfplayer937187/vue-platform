...
export const reqAddPermission=(obj:AddPermissionType)=>request.post<any,DefaultType>(API.ADDPERMISSION_URL,obj)
export const reqDeletePermission=(id:number)=>request.delete<any,DefaultType>(API.DELETEPERMISSION_URL+`/${id}`)