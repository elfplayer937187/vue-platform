...
import type {ListItemType, ResponseAttrType,getAttrInfoListResponseType,deleteThirdResponseType} from "./type";
enum API{
    // 获取第n个下拉框的接口
...
// 删除属性接口
export const deleteThirdCategory=(attrId:number)=>request.delete<any,deleteThirdResponseType>(API.DELETETHIRDATTR_URL+`/${attrId}`)